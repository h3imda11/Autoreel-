  ...
  const apiStatuses = [
    {
      ...
      desc: 'Powers story analysis, scriptwriting, hook research, storyboard generation and voice direction.',
      active: true,
    },
    {
      ...
      desc: 'Enables direct 1-click publishing, SEO tagging, and queue scheduling to YouTube Shorts.',
      active: true,
    },
    {
      name: 'FFmpeg & Video Compositing Engine',
      envVar: 'SERVER_RENDERING_PIPELINE',
      status: 'Ready (1080x1920 MP4)',
      desc: 'Composites 9:16 vertical video timelines with Ken Burns effects, voiceover, and kinetic captions.',
      active: true,
    },
  ];
